/* Oringal: https://github.com/schnoggo/jack-o-candle/blob/master/jack-o-candle.ino
Modifed By: https://github.com/LakesideMiners/
*/
...
#define PIN 3              // Which pin are those Neopixels hook up to?
